...
| 09:20-11:35 | 第1部: 画像解析にまつわる基礎(筑波大学・根本)
| 09:20-10:25 | 第1部(1): DICOM, NIFTIの理解
|             | 脳画像をいじるうえで必要なDICOM形式、NIFTI形式について理解し、<br>画像情報の確認するツールおよび方法を学びます
| 10:35-11:40 | 第1部(2): GLM入門
|             | 脳画像統計解析の基本である一般線形モデルについて学びます
| 11:40-12:40 | -- 昼休み --
| 12:40-14:50 | 第2部: DWI解析の基礎(慶應義塾大学病院・上田)
| 12:40-13:40 | 第2部(1): DWIの前処理
|             | DTIを用いた統計解析であるTract based spatial statistics（TBSS）を<br>行う上で必要な前段の画像処理を実際に体験します
| 13:55-14:55 | 第2部(2): TBSS(Non-FA Analysisも含む)
|             | DTIを用いた統計解析 TBSS を実際に体験します
| 15:10-16:10 | 第2部(3): DWIにおけるGLMの実際 (ケーススタディ)
|             | 群間比較、相関解析、共変数を考慮したTBSS解析のための<br>デザインマトリクスとデザインコントラストの作成を中心に学びます
| 16:25-17:25 | 第2部(4): 拡散テンソルの基礎と3D Slicerを用いたトラクトグラフィーの描出
